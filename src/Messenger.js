	...
	render(){
		if(this.state.messages && this.state.currentUser){
			return(
				<div className="container col s12">
					...
					<button className="btn waves-effect waves-light right logout" onClick={()=>{this.signout()}}>LOGOUT
		...
		<div className="container">
		  <div className="progress black">
			...
			<button className="btn waves-effect waves-light" onClick={()=>{this.signin()}}>LOGIN
							<i className="material-icons right">person</i>
						</button>
		</div> 
	)
